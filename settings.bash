...
function settings () {
    ...
    working_directory="/tmp/build-arch-lts"
    ...
    image_file_path="/home/hayao/archlinux-lts-${year}.${month}.${day}-${make_arch}.iso"
    ...
    ##メッセージファイルへのパス
    message_file_path=/tmp/message.conf
    ...
    archiso_configs_git="https://github.com/Hayao0819/archlinux-lts-live.git"
    ...
    archiso_configs="/tmp/git_clone/configs"
